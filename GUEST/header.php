...
<body>
    <nav class="navbar navbar-expand-sm">
        <a class="navbar-brand" href="#">
            <img src="../assets/img/Logo tách nền.png" alt="Avatar Logo" class="rounded-pill">
        </a>
        <div class="container ">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <button type="button" class="btnlogin text-sm-right" href="login.php">ĐĂNG NHẬP</button>
